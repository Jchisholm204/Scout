...
int main(int argc, char **argv) {
    ...
    rclcpp::spin(std::make_shared<RPLIDARBridge>());
    rclcpp::shutdown();
...
//                 }
//                 else{
//                     fprintf(stderr, "Failed to get devinfo: 0x%X\n", op_result);
//                     delete drv;
// 					drv = NULL;
//                 }
//             }
//             else {
//                 fprintf(stderr, "drv->connect() failed for %s at baud %u, sl_result=0x%X\n", opt_channel_param_first, 0, op_result);
//             }
//         }
//         else{
...
//                 if (!_channel) {
//                     fprintf(stderr, "Failed to create serial channel %s at baud %u: %s\n",
//                         opt_channel_param_first, baudrateArray[i], strerror(errno));
//                     continue;
//                 }
//                 if (SL_IS_OK((drv)->connect(_channel))) {
//                     op_result = drv->getDeviceInfo(devinfo);
...
//                 }
//                 else {
//                     fprintf(stderr, "drv->connect() failed for %s at baud %u, sl_result=0x%X\n", opt_channel_param_first, baudrateArray[i], op_result);
//                 }
// 			}
//         }
//     }
