...
Planner::Planner() : Node("path_planner") {
    ...
    this->declare_parameter("battery_topic", "sim/imu");
    ...
    _battery_sub = this->create_subscription<sensor_msgs::msg::BatteryState>(
        imu_topic, 10, std::bind(&Planner::_batt_callback, this, std::placeholders::_1));
    _mode_sub = this->create_subscription<std_msgs::msg::UInt8>(
        imu_topic, 10, std::bind(&Planner::_mode_callback, this, std::placeholders::_1));
    _vertical_scan_sub = this->create_subscription<sensor_msgs::msg::LaserScan>(
        imu_topic, 10, std::bind(&Planner::_vldr_callback, this, std::placeholders::_1));
    _horizontal_scan_sub = this->create_subscription<sensor_msgs::msg::LaserScan>(
        imu_topic, 10, std::bind(&Planner::_hldr_callback, this, std::placeholders::_1));
    _pos_sub = this->create_subscription<geometry_msgs::msg::Point>(
        imu_topic, 10, std::bind(&Planner::_pos_callback, this, std::placeholders::_1));
    _vel_sub = this->create_subscription<geometry_msgs::msg::Vector3>(
        imu_topic, 10, std::bind(&Planner::_vel_callback, this, std::placeholders::_1));
