 ...
 * @modified Last Modified: 2026-03-04
 *
 * @copyright Copyright (c) 2026
 */


#ifndef _PINS_CAPSTONE_CB_H_
#define _PINS_CAPSTONE_CB_H_
#include "hal/pin.h"
#define _BOARD_CONFIG_

#define PIN_LED3 PIN('C', 6)
...
#define PIN_USART3_RX PIN('C', 10)
#define PIN_USART3_TX PIN('C', 11)

#define PIN_UART4_RX PIN('A', 0)
#define PIN_UART4_TX PIN('A', 1)

#define PIN_UART5_RX PIN('D', 2)
#define PIN_UART5_TX PIN('C', 12)

#define PIN_USART6_RX PIN('C', 3)
#define PIN_USART6_TX PIN('C', 2)
